...
import { APP_NAME, CONTACT_EMAIL, CONTACT_PHONE, CONTACT_WHATSAPP, CONTACT_INSTAGRAM, CONTACT_FACEBOOK } from '@/config/app';
...
export function ContactPage() {
	...
	const instagramHref = CONTACT_INSTAGRAM
		...
		: '';
	const facebookHref = CONTACT_FACEBOOK
		? CONTACT_FACEBOOK.startsWith('http') ? CONTACT_FACEBOOK : `https://facebook.com/${CONTACT_FACEBOOK}`
		: '';
		...
		<div>
			...
			<section className="max-w-5xl mx-auto px-6 py-14 md:py-20">
				...
				<div className="grid grid-cols-1 sm:grid-cols-3 gap-5 mb-5">
					...
					<ContactCard
						platform="Facebook"
						description="Like our page to stay in the loop with news, litter announcements, and puppy stories."
						icon={<FacebookIcon />}
						value={CONTACT_FACEBOOK}
						href={facebookHref}
						buttonLabel="Find us on Facebook"
						iconBg="bg-blue-50"
